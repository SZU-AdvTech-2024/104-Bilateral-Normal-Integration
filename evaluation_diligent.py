...
import cv2
import os
#为了复现定量评估，首先下载GT 深度图并将其解压到根目录中，然后运行本脚本，下载链接https://www.dropbox.com/scl/fi/uhg8538lr43h2g2arim2l/diligent_depth_GT.zip?rlkey=4qdmse25e0lmrtbo9bsfvifk1&e=1&dl=0
